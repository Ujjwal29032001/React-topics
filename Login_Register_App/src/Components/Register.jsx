...
function Register() {
        ...
        var registerUser = (event)=>{
            ...
            var resp = fetch("http://tutorials.codebetter.in:7084/auth/save",{
                method:'POST',
                headers:{
                    'Content-Type':'application/json',//Ensures theserver known it's JSON
                },
            ...
            resp.then(res=>res.json()).then((result)=>{
                {
                    ...
                    {
                        navigate("/"); //this function to create a url or accept Switching URL
                    }
                    else{
    ...
    return<div className="container">
        ...
        <form onSubmit={registerUser}>
            ...
            <div className='form-label'>
                <input type='text' placeholder='Enter Contact' ref={contact} className='form-control'/>
            </div>
            <div className='form-label'>
